...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function onAdd() {
            Ext.get('txtLoaivanban').setValue('');
        ...
        function onEdit() {
            if (GridPanel1.hasSelection()) {
                ...
                Ext.get('txtLoaivanban').setValue(record.data.LOAIVB);
        ...
        function insertNewRow() {
            ...
            var loaiVB = Ext.get('txtLoaivanban').getValue();

            if (rowIndex == -1) {
                GridPanel1.insertRecord(0, { IDLOAIVB: 0, LOAIVB: loaiVB});
            } else {
                var grid = GridPanel1,
                    record = grid.getSelectionModel().getSelected();
                record.set("LOAIVB", loaiVB);
            }
        }
...
<body>
    ...
    <ext:Store ID="Store1" runat="server" WarningOnDirty="false">
        <Proxy>
            <ext:HttpProxy Json="true" Method="POST" Url="~/Admin/LoaiVanbanList/" />
        </Proxy>
        <Reader>
        ...
        <UpdateProxy>
            <ext:HttpWriteProxy Url="~/Admin/LoaiVanbanList_Save/" />
        </UpdateProxy>
        <Listeners>
                ...
                <ext:FormPanel ID="FormPanel1" 
                    ...
                    <Items>
                        <ext:TextField 
                            ...
                            AllowBlank="false"
                            MaxLength="50"
                            BlankText="Hãy nhập loại văn bản"
                            Width="170"
                            >
                            </ext:TextField>
                        <ext:NumberField 
    ...
    <ext:GridPanel ID="GridPanel1" 
           ...
           <ColumnModel ID="ColumnModel1" runat="server">
                <Columns>
                    ...
                    <ext:Column ColumnID="LOAIVB" Header="Loại văn bản" DataIndex="LOAIVB" Width="250" Sortable="true" />
                </Columns>
            </ColumnModel>
            <SelectionModel>
